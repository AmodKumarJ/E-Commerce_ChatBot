			...
			<div class="row">
                                    ...
                                    foreach ($_SESSION['cart_item'] as $item) {
                                        ...
                                        ?>
                                            <tr class="table_row"><form method="POST">
                                                ...
                                                <td class="column-2"><?php echo $item['productName'];?></td>
                                                ...
                                                <td class="p-3">
                                                    <input type="hidden" name="pid" value="<?php echo $item['productId'];?>">
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<a href="payment.php" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
							Proceed to Checkout
                                </a>
					</div>
				</div>
