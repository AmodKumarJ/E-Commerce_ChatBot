...
<html lang="en">
<head>
    <title>Crafts - <?php echo $site;?></title>
	<meta charset="UTF-8">
...
?>
    ...
    $sql = "SELECT * FROM product_master WHERE product_status = 1 AND category_id = 2";
                    ...
                    <?php
                        for($i = 1; $i<= $number_of_page; $i++) {  
                            if($i <= $page+$number_of_page && $i >= $page){
                                ...
                                echo "<a href='crafts.php?page=$i' class='flex-c-m how-pagination1 trans-04 m-all-7";
                                if($page==$i){
