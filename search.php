...
?>
    ...
    $sql = "SELECT * FROM product_master WHERE product_status = 1 AND product_name LIKE '%$source%'";
                    ...
                    <?php
                        for($i = 1; $i<= $number_of_page; $i++) {  
                            if($i <= $page+$number_of_page && $i >= $page){
                                ...
                                echo "<a href='search.php?search=$source&page=$i' class='flex-c-m how-pagination1 trans-04 m-all-7";
                                if($page==$i){
