...
?>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="active-menu">
								<a>Shop</a>
                                <ul class="sub-menu">
									<li><a href="shop.php?id=1">Casual Wear</a></li>
									<li><a href="shop.php?id=2">Wedding Dress</a></li>
									<li><a href="shop.php?id=3">Gown</a></li>
									<li><a href="shop.php?id=4">Vintage</a></li>
								</ul>
							</li>
    ...
    $sql = "SELECT * FROM product_master WHERE product_status = 1 AND category_id = 1";
	...
	<section class="bg0 p-t-62">
			...
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						<!-- item blog -->
						<div class="p-b-63">
                        <h3 class="ltext-103 cl5">Best Seller</h3>
                    ...
                    <?php
                        for($i = 1; $i<= $number_of_page; $i++) {  
                            if($i <= $page+$number_of_page && $i >= $page){
                                ...
                                echo "<a href='frames.php?page=$i' class='flex-c-m how-pagination1 trans-04 m-all-7";
                                if($page==$i){
        ...
        <div class="col-md-4 col-lg-3 p-b-80">
            <div class="side-menu">
            <?php
                $resCate = mysqli_query($conn, "SELECT * FROM category_master WHERE category_status = 'Active'");
                ...
                <div>
                    ...
                    <?php
                        ...
                        <li class="bor18">
                            <a href="shop.php?id=<?php echo $rowCat['category_id'];?>" class="dis-block stext-115 cl6 hov-cl1 trans-04 p-tb-8 p-lr-4">
