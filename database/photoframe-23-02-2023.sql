...
INSERT INTO `login_master` (`login_id`, `user_email_id`, `login_password`, `user_type`, `date_create`) VALUES
	(1, 'manojkpajeer127@gmail.com', 'safdasdasda', 'User', '2023-02-13 05:10:40'),
	(3, 'admin@gmail.com', 'admin123', 'Admin', '2023-02-13 05:18:47');
...
INSERT INTO `order_master` (`order_id`, `user_id`, `transaction_id`, `order_status`, `order_date`) VALUES
	(1, 1, '167689181263F356A4CE191', 'Order Shipped', '2023-02-20 11:16:52'),
	(2, 1, '167689282663F35A9A5F656', 'Order Delivered', '2023-02-20 11:33:46');
...
-- Dumping data for table photo_frame.order_temp: ~3 rows (approximately)
...
-- Dumping data for table photo_frame.payment_master: ~2 rows (approximately)
...
INSERT INTO `product_master` (`product_id`, `category_id`, `product_image`, `product_image_2`, `product_image_3`, `product_name`, `product_price`, `product_description`, `product_status`, `product_date_create`) VALUES
	...
	(13, NULL, '11677066410.png', '21677066410.png', '31677066410.png', 's', 10000, 'd', 1, '2023-02-22 11:46:50'),
	(14, NULL, '11677066563.png', '21677066563.png', '31677066563.png', 'Suresh', 10000, 'sdxz', 1, '2023-02-22 11:49:23'),
	(15, NULL, '11677066591.png', '21677066591.png', '31677066591.png', 'Suresh', 10000, 'uikj', 1, '2023-02-22 11:49:51'),
	(16, NULL, '11677066627.png', '21677066627.png', '31677066627.png', 'Suresh', 10000, 'uikj', 0, '2023-02-22 11:50:27'),
	(19, 1, '11677067026.png', '21677067026.png', '31677067026.jpg', 'Harish', 10000, 'ytgjbh', NULL, '2023-02-22 11:57:07');
...
INSERT INTO `user_master` (`user_id`, `user_name`, `user_email_id`, `user_phone_number`, `address_line_1`, `address_line_2`, `pin_code`, `city`, `user_date_create`, `user_status`) VALUES
	(1, 's', 'manojkpajeer127@gmail.com', '8904653322', 'asdw', 'adssadasw', '222222', 'cccw', '2023-02-13 05:10:40', 1);
