    ...
    if(isset($_POST['add'])){ 
        ...
        if ($i1&&$i2&&$i3) {
            ...
            if(mysqli_query($conn, "INSERT INTO product_master(product_image,product_image_2,product_image_3,
                product_name,product_price,product_description,category_id, product_status, product_date_create) 
                VALUES ('$path_banner_1','$path_banner_2','$path_banner_3','$name','$price','$description','$category', 'Active', NOW())")){
                                    ...
                                    <?php
                                        ...
                                        if (mysqli_num_rows($resData) > 0) {
                                            ...
                                            while($rowData = mysqli_fetch_assoc($resData)) {
                                                ...
                                                echo "<td>".$rowData['product_price']."</td>"; 
                                                ...
                                                ?>
                                                <form method="POST">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal<?php echo $rowData['product_id'];?>"><i class='fa fa-edit'></i></a>
 |
